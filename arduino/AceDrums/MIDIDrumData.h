...
class MIDIDrumData {
  public:
    ...
    static const byte closed_edge = 22;
    static const byte closed_tip = 13;
    static const byte tight_edge = 62;
    static const byte tight_tip = 15;
    static const byte seq_hard = 16;
    static const byte seq_soft = 17;
    static const byte open_1 = 24;
    static const byte open_2 = 25;
    static const byte open_3 = 26;
    static const byte open_4 = 60;
    static const byte open_5 = 17;
